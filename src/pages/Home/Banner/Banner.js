      ...
      <div>
        <div className="lg:px-32 md:px-20 sm:px-10 px-5">
          <div className="lg:flex gap-10">
            <div className="lg:w-1/2 flex justify-center items-center  lg:pt-0 pt-5 order-1">
            ...
            <div className="lg:w-1/2 mb-2 pt-2 flex justify-center items-center">
              <div className="">
                ...
                <p className="sm:text-xl sm:mt-8 mt-3 text-lg text-neutral  text-justify">
                ...
                <div className="sm:mt-10 mt-5">
                  <div className="grid sm:grid-cols-3 sm:gap-0 gap-5">
                    <div>
                      <h1 className="text-center font-semibold text-primary text-2xl">262k+</h1>
                      <p className="text-neutral text-center">Recovered Patients</p>
                    </div>
                    <div>
                      <h1 className="text-center font-semibold text-primary text-2xl">96%</h1>
                      <p className="text-neutral text-center">Satisfaction Rate</p>
                    </div>
                    <div>
                      <h1 className="text-center font-semibold text-primary text-2xl">86+</h1>
                      <p className="text-neutral text-center">Expert Doctors</p>
                    </div>
                  </div>
                </div>
              </div>
