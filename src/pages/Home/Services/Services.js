...
import dentalLogo from "../../../assets/medical-icon_i-dental.png";
import briefcase from "../../../assets/fluent_briefcase-medical-32-filled.png";
import clipboard from "../../../assets/bi_clipboard2-check-fill.png";

const Services = () => {
  return (
    <div className="lg:px-32 md:px-20 sm:px-10 px-5 mt-10">
      <div className="text-center">
        <h1 className="text-secondary sm:text-xl">Our Services</h1>
        <p className="text-accent text-2xl sm:text-4xl">Services For Your Health</p>
      </div>
      <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gap-5 mt-10">
        <div className="bg-base-100 rounded-lg p-3">
          ...
          <p className="text-neutral  text-justify">Seduahag perspiciati under omnised atused error.</p>
